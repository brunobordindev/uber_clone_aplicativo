        ...
        usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (usuario.getCarro() == null){
                    ...
                    binding.editConfigModeloCarro.setText(usuario.getCarro().getModelo());
                    binding.editConfigMarcaCarro.setText(usuario.getCarro().getMarca());
                    binding.editConfigPlacaCarro.setText(usuario.getCarro().getPlaca());
                    binding.editConfigAnoCarro.setText(usuario.getCarro().getAno());
                }
